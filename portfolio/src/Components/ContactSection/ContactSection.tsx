...
//           isSuccess: false,
//           error:
//             "Email service not configured. Please contact me directly at fikreddu@gmail.com",
//         });
//         return;
//       }
...
//           isSubmitting: false,
//           isSuccess: false,
//           error: "Failed to send message. Please contact me directly.",
//         });
//       }
//     },
//     [validateEmailJSConfig, reset]
...
//           Contact
//         </h2>
//         <div className="mx-auto h-1 w-20 bg-blue-500 rounded" />
//       </header>

//       <div
//         ref={containerRef}
//         className="bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl border border-gray-600 p-6 max-w-5xl mx-auto flex flex-col lg:flex-row gap-6"
//       >
//         {/* Left */}
//         <div className="w-full lg:w-1/2">
...
//                   key={c.label}
//                   href={c.href}
//                   className="flex items-center gap-3 p-2 rounded-lg bg-gray-800/50 hover:bg-gray-800"
//                 >
