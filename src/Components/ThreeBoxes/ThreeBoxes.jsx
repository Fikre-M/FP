...
//               originally from Ethiopia and currently reside in New York, US. As
//               a full-stack developer with a unique background in teaching and
...
//         <div className="flex-1 bg-gray-700 rounded-lg shadow-md p-6">
...
//           <div className="flex-1 md:max-w-xs bg-gray-700 rounded-lg shadow-md p-6 flex flex-col items-center justify-center">
...
//           <div className="flex-1 bg-gray-700 rounded-lg shadow-md p-6 flex flex-col items-center justify-center">
//             <h3 className="text-lg font-semibold text-white mb-2">Let's Work Together</h3>
//             <p className="text-gray-300 text-center">
//               Interested in collaborating? Reach out to discuss your project or idea!
//             </p>
//           </div>
//           {/* Credentials Container */}
//           <div className="flex-1 bg-gray-700 rounded-lg shadow-md p-6 flex flex-col items-center justify-center">
//             <h3 className="text-lg font-semibold text-white mb-2">Credentials</h3>
//             <p className="text-gray-300 text-center">
//               View certifications, awards, and other professional credentials here.
//             </p>
//           </div>
//         </div>
//     </>
