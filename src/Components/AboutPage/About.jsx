  ...
  return (
    <>
      ...
      <div className="bg-gray-800 rounded-xl shadow-2xl p-8 w-full max-w-5xl mx-auto">
        {/* About Section */}
        <div className="w-full flex flex-col md:flex-row items-center md:items-stretch min-h-[400px] shadow-lg hover:shadow-2xl hover:-translate-y-2 transition duration-300 cursor-pointer">
          ...
          <div className="flex justify-center md:justify-end items-center w-full md:w-1/3 md:pl-12 mb-8 md:mb-0">
            <div className="rounded-full border-4 border-double border-blue-500 w-60 h-60 md:w-72 md:h-72 overflow-hidden shadow-lg mr-14">
              <img
                src={se2Image}
                alt="Fikre"
        ...
        <div className="w-full flex flex-col md:flex-row gap-6 mt-8">
          ...
          <div className="flex-1 bg-gray-700 rounded-lg p-6 border-4 border-double border-blue-500 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition duration-300 cursor-pointer">
        ...
        <div className="w-full flex flex-col md:flex-row gap-6 mt-8">
          ...
          <div className="flex-1 md:max-w-xs bg-gray-700 rounded-lg p-6 flex flex-col items-center justify-center border-4 border-double border-blue-500 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition duration-300 cursor-pointer">
          ...
          <div className="flex-1 bg-gray-700 rounded-lg p-6 flex flex-col items-center justify-center border-4 border-double border-blue-500 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition duration-300 cursor-pointer">
